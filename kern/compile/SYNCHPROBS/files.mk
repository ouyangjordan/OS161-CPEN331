...
SRCS+=$(KTOP)/compile/SYNCHPROBS/autoconf.c
...
SRCS+=$(KTOP)/syscall/chdir.c
SRCS+=$(KTOP)/syscall/close.c
SRCS+=$(KTOP)/syscall/dup2.c
SRCS+=$(KTOP)/syscall/file.c
SRCS+=$(KTOP)/syscall/fork.c
SRCS+=$(KTOP)/syscall/__getcwd.c
SRCS+=$(KTOP)/syscall/loadelf.c
SRCS+=$(KTOP)/syscall/lseek.c
SRCS+=$(KTOP)/syscall/open.c
